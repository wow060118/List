...
public class FallAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if (i == view_Normal) {
            viewHolder = new FallHolder(viewGroup.inflate(fContext, R.layout.demo_follow_fall, null));
        } else if(i==view_Foot){
            viewHolder = new FootViewHolder(viewGroup.inflate(fContext, R.layout.demo_follow_fall, null));
        }
        return viewHolder;
    }
