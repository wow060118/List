package com.example.yfr.demo.advice;
...
import com.example.yfr.demo.entity.AdviceEntity;
import com.example.yfr.demo.entity.RadioEntity;
import com.example.yfr.demo.util.SystemUtil;
...
public class AdviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_advice);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("demo_advice", JSON.toJSONString(adviceEntity));
