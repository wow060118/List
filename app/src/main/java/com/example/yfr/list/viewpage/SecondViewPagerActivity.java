...
public class SecondViewPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle startInstance) {
        ...
        setContentView(R.layout.second_view_pager);

        initData();

        viewPager = findViewById(R.id.second_pic_view);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                Toast.makeText(SecondViewPagerActivity.this, "第" + position + "图", Toast.LENGTH_LONG).show();
            }
